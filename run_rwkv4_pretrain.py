...
def main(config):
    ...
    train(
        ...
        repr_len=config_data['rep_len'],
        patch_size=config_data['patch_size'],
        use_frame_target=config_loss['pred_frame'],
        use_ts_target=config_loss['pred_ts'],
        use_next_frame_target=config_loss['pred_next_frame'],
        ts_tau=config_loss['tau'],
